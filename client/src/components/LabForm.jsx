...
function LabForm() {
      ...
      (async () => {
        try {
          ...
          setFormData({
            ...
            funding_status: data.funding_status || 'unfunded',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        const data = await res.json();
        navigate(isEditing ? `/labs/${id}` : `/labs/${data._id}`);
      } else {
        alert('Failed to save lab listing');
      }
    } catch (error) {
  ...
  return (
    <div className="lab-form-page">
      ...
      <form className="lab-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <label htmlFor="professor">Professor / PI</label>
          <input
            id="professor"
            name="professor"
            type="text"
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            <label htmlFor="funding_status">Funding</label>
            <select
              id="funding_status"
              name="funding_status"
        ...
        <div className="form-group">
          <label htmlFor="website">Lab Website (optional)</label>
          <input
            id="website"
            name="website"
            type="url"
